...
RATE_LIMIT_REQUESTS = int(os.environ.get("SOLARIS_RATE_LIMIT_RPM", "60"))
...
app = FastAPI(
    title="Project Solaris Prediction API",
    version="0.2.0",
    description="Operational Decision-Support API for Project Solaris flare predictions",
)
...
def load_predictions() -> pd.DataFrame:
    ...
    parquet_path = ROOT / "reports" / "predictions" / "solaris_mvp_predictions.parquet"
