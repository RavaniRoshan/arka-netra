...
class TestSEPRiskModel:
    def test_minimal_risk_no_factors(self):
        from solaris.radiation.sep_model import SEPRiskModel
        model = SEPRiskModel()
        result = model.assess()
    ...
    def test_compute_sep_risk_index_dataframe(self):
        from solaris.radiation.sep_model import compute_sep_risk_index
        df = pd.DataFrame({
...
class TestSatelliteRisk:
    def test_assess_satellite_risk_geo(self):
        from solaris.radiation.satellite_risk import assess_satellite_risk, SatelliteOrbit
    ...
    def test_add_satellite_risk_to_predictions(self):
        from solaris.radiation.satellite_risk import add_satellite_risk_to_predictions
...
class TestHumanSpaceflight:
    def test_estimate_dose_rate_leo(self):
        from solaris.radiation.human_spaceflight import estimate_dose_rate
    ...
    def test_shielding_reduces_dose(self):
        from solaris.radiation.human_spaceflight import estimate_dose_rate, ShieldingLevel
    ...
    def test_eva_phase_increases_dose(self):
        from solaris.radiation.human_spaceflight import estimate_dose_rate, MissionPhase
    ...
    def test_mission_dose_calculation(self):
        from solaris.radiation.human_spaceflight import estimate_mission_dose
    ...
    def test_eva_dose_estimation(self):
        from solaris.radiation.human_spaceflight import estimate_eva_dose
    ...
    def test_compute_human_dose_for_predictions(self):
        from solaris.radiation.human_spaceflight import compute_human_dose_for_predictions
